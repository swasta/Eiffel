...
void egc_init_plug (void)
{
	...
	egc_system_name = "coffee_shop";
	egc_system_location = "/Users/nikitaborodulin/Desktop/Innopolis/OOP/COFFEE_SHOP/EIFGENs/coffee_shop/W_code";
	egc_compiler_tag = 38;
