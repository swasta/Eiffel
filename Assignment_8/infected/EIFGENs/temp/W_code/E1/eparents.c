...
/* V_STRING_OUTPUT */
static EIF_TYPE_INDEX ptf862[] = {906,0,0xFFFF};
...
/* V_MUTABLE_SEQUENCE_ITERATOR [G#1] */
static EIF_TYPE_INDEX ptf907[] = {900,0xFFF8,1,0xFFF7,905,0xFFF8,1,0xFFFF};
