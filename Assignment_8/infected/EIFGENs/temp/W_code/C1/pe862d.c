...
static const EIF_TYPE_INDEX egt_13_862 [] = {909,861,0xFFFF};
...
static const struct desc_info desc_862[] = {
	...
	{EIF_NON_GENERIC(0x01B9 /*220*/), 12650, 0},
	{EIF_GENERIC(egt_13_862), 12651, 8},
	{EIF_NON_GENERIC(0x017F /*191*/), 12652, 16},
