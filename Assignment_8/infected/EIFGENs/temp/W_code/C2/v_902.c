...
extern void F902_7353(EIF_REFERENCE, int);
extern void EIF_Minit902(void);
extern EIF_REFERENCE _A902_62_2_3();
...
EIF_TYPED_VALUE F902_7354 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 901, Current, 0, 2, 13029);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(901, Current, 13029);
	RTCC(arg2, 901, l_feature_name, 2, RTWCT(4916, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	...
	ui4_1 = ti4_1;
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4944, "item", tr2))(tr2, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
void F902_7353 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 901, Current, 0, 7352);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	*((EIF_INTEGER_32 *)tr4+1) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	...
	
	{
		...
		typres0 = eif_compound_id(dftype, typarr0);
		tr5 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A902_62_2_3, (EIF_POINTER)(0),5179, tr3, 0, 1, 901, tr2, 2);
	}
	ur1 = RTCCL(tr5);
